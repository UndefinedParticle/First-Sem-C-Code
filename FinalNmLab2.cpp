...
#include<cmath>    //Admission No is => 21MS044
#include<iomanip>
using namespace std;
int main(){
    cout<<"Lower bound of  x => ";// like for this output x1=0
    int x1;cin>>x1;cout<<endl;
    cout<<"Upper bound of  x => ";// like for this output x2=4
    int x2;cin>>x2;cout<<endl;
    cout<<"Lower bound of  y => ";// like for this output y1=0
    int y1;cin>>y1;cout<<endl;
    cout<<"Upper bound of  y => ";// like for this output y2=4
